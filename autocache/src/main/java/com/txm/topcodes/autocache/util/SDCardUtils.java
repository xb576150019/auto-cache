...
public class SDCardUtils {
	...
	public static boolean saveFileToSDCardPrivateFilesDir(byte[] data, String type, String fileName, Context context) {
		BufferedOutputStream bos = null;
		if (isSDCardMounted()) {
			File dirPath = context.getExternalFilesDir(type);
			if (dirPath == null) {
				dirPath = new File("/storage/emulated/0/Android/data/cn.edu.bnu.lcell.preparelessions/files/Pictures");
			}
			try {
	...
	public static String getSDCardPrivateFileDir(Context context, String type, String fileName) {
